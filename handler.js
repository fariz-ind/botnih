        ...
        try {
            ...
            try {
                ...
                if (chat) {
                    ...
                    if (!('sWelcome' in chat)) chat.sWelcome = '+ ࣪ ₊ ꮺ 𝖧𝖺𝗂  @user! ❗“◛◞𓍢ヾ'
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                           ...
                           text = (action === 'add' ? 
                            (`+ ࣪ ₊ ꮺ 𝖧𝖺𝗂i @user ❗“◛◞𓍢ヾ\n\n𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 ${gpname} 𝗒𝖾𝖺𝖺!!\n𝖠𝗒𝗈 𝖻𝖾𝗋𝖻𝖺𝗎𝗋 𝗇 𝗄𝖾𝗇𝖺𝗅𝗇, 𝗆𝖺𝗌𝖺 𝗌𝖾𝗌𝖺𝗆𝖺 𝖼𝖺𝗆𝖺𝖻𝖺 𝗀𝖺 𝗌𝖺𝗅𝗂𝗇𝗀 𝗆𝖾𝗇𝗀𝖾𝗇𝖺𝗅𝗂 𝗒𝖺𝗄𝖺𝗇😁☝️\n\nNote ᝰ.ᐟ\n᭝ untuk menu informasi ketik ".info"!\n᭝ info penting ada dipin/info camaba\n᭝ jangan malu-malu plz ayo berteman` || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc ? String.fromCharCode(8206).repeat(4001) + groupMetadata.desc : '') :
...
contextInfo: {
     mentionedJid: [user],
      ...
      newsletterJid: '120363252742621904@newsletter',
            ...
            forwardingScore: 256,
externalAdReply: {
        title: action === 'add' ? `🔴 Welcome New Member <⁠(⁠￣⁠︶⁠￣⁠)⁠>\n• Name Group: ${gpname}` : `🔴 Sayonara My member (⁠ ⁠≧⁠Д⁠≦⁠)\n• Name Group: ${gpname}`,
